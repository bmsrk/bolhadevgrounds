...
export const STATIC_GAME_MAP: GameMap = {
  ...
  colliders: [
    // ── Outer walls ──────────────────────────────────────────────────────────
    { x:    0, y:   0, w: 1280, h:  16, label: 'outer-top'    },
    { x:    0, y: 704, w: 1280, h:  16, label: 'outer-bottom' },
    { x:    0, y:   0, w:   16, h: 720, label: 'outer-left'   },
    { x: 1264, y:   0, w:   16, h: 720, label: 'outer-right'  },

    // ── Horizontal wall — row 17 (y = 272, top corridor border) ──────────────
    // Open Workspace section (cols 1-17), 4-tile door at cols 7-10 (x = 112-176)
    { x:  16, y: 272, w:  96, h: 16, label: 'cw-t-ow-l' },
    { x: 176, y: 272, w: 112, h: 16, label: 'cw-t-ow-r' },
    // Meeting Room section (cols 19-44), door at cols 29-32 (x = 464-528)
    { x: 304, y: 272, w: 160, h: 16, label: 'cw-t-mt-l' },
    { x: 528, y: 272, w: 192, h: 16, label: 'cw-t-mt-r' },
    // Engineering section (cols 46-78), door at cols 60-63 (x = 960-1024)
    { x: 736, y: 272, w: 224, h: 16, label: 'cw-t-en-l' },
    { x:1024, y: 272, w: 240, h: 16, label: 'cw-t-en-r' },

    // ── Horizontal wall — row 20 (y = 320, bottom corridor border) ───────────
    // Lounge section, door at cols 7-10
    { x:  16, y: 320, w:  96, h: 16, label: 'cw-b-lg-l' },
    { x: 176, y: 320, w: 112, h: 16, label: 'cw-b-lg-r' },
    // Product Area section, door at cols 29-32
    { x: 304, y: 320, w: 160, h: 16, label: 'cw-b-pr-l' },
    { x: 528, y: 320, w: 192, h: 16, label: 'cw-b-pr-r' },
    // Design Studio section, door at cols 60-63
    { x: 736, y: 320, w: 224, h: 16, label: 'cw-b-ds-l' },
    { x:1024, y: 320, w: 240, h: 16, label: 'cw-b-ds-r' },

    // ── Vertical wall — col 18 (x = 288) ─────────────────────────────────────
    // Top zone: 4-tile door at rows 7-10 (y = 112-176)
    { x: 288, y:  16, w: 16, h:  96, label: 'vw1-t-a' },
    { x: 288, y: 176, w: 16, h:  96, label: 'vw1-t-b' },
    // Bottom zone: 4-tile door at rows 30-33 (y = 480-544)
    { x: 288, y: 336, w: 16, h: 144, label: 'vw1-b-a' },
    { x: 288, y: 544, w: 16, h: 160, label: 'vw1-b-b' },

    // ── Vertical wall — col 45 (x = 720) ─────────────────────────────────────
    // Top zone
    { x: 720, y:  16, w: 16, h:  96, label: 'vw2-t-a' },
    { x: 720, y: 176, w: 16, h:  96, label: 'vw2-t-b' },
    // Bottom zone
    { x: 720, y: 336, w: 16, h: 144, label: 'vw2-b-a' },
    { x: 720, y: 544, w: 16, h: 160, label: 'vw2-b-b' },

    // ── Open Workspace desks (2 columns × 3 rows) ─────────────────────────────
    { x:  30, y:  35, w: 90, h: 40 },
    { x:  30, y: 108, w: 90, h: 40 },
    { x:  30, y: 180, w: 90, h: 40 },
    { x: 160, y:  35, w: 90, h: 40 },
    { x: 160, y: 108, w: 90, h: 40 },
    { x: 160, y: 180, w: 90, h: 40 },
    // Reception desk
    { x: 170, y: 226, w: 90, h: 34 },

    // ── Meeting Room — conference table ───────────────────────────────────────
    { x: 380, y:  78, w: 264, h: 138 },

    // ── Engineering desks (2 rows × 5 columns) + server rack ──────────────────
    { x:  752, y:  30, w: 80, h: 40 },
    { x:  852, y:  30, w: 80, h: 40 },
    { x:  952, y:  30, w: 80, h: 40 },
    { x: 1052, y:  30, w: 80, h: 40 },
    { x: 1152, y:  30, w: 80, h: 40 },
    { x:  752, y: 122, w: 80, h: 40 },
    { x:  852, y: 122, w: 80, h: 40 },
    { x:  952, y: 122, w: 80, h: 40 },
    { x: 1052, y: 122, w: 80, h: 40 },
    { x: 1152, y: 122, w: 80, h: 40 },
    { x: 1194, y:  22, w: 56, h: 242, label: 'server-rack' },

    // ── Lounge: kitchen counter + sofas + game table ───────────────────────────
    { x:  22, y: 338, w: 252, h: 36 },  // kitchen counter
    { x:  22, y: 408, w: 106, h: 56 },  // sofa A
    { x:  22, y: 528, w: 106, h: 56 },  // sofa B
    { x: 158, y: 578, w: 92,  h: 66 },  // game table

    // ── Product Area desks (2 rows × 3 columns, clear of spawn at 640,360) ─────
    { x: 318, y: 380, w: 80, h: 40 },
    { x: 440, y: 380, w: 80, h: 40 },
    { x: 562, y: 380, w: 80, h: 40 },
    { x: 318, y: 460, w: 80, h: 40 },
    { x: 440, y: 460, w: 80, h: 40 },
    { x: 562, y: 460, w: 80, h: 40 },
    // Kanban board wall (south side)
    { x: 314, y: 632, w: 396, h: 52 },

    // ── Design Studio desks (1 row × 4 columns) + large display + boards ──────
    { x:  748, y: 363, w: 80, h: 40 },
    { x:  868, y: 363, w: 80, h: 40 },
    { x:  988, y: 363, w: 80, h: 40 },
    { x: 1108, y: 363, w: 80, h: 40 },
    { x: 1146, y: 443, w: 100, h: 204 },  // large display wall
    { x:  742, y: 553, w: 132, h:  72 },  // drawing board A
    { x:  898, y: 553, w: 132, h:  72 },  // drawing board B
  ],
